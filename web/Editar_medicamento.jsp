    ...
    <body>
        ...
        <div id="page">
            ...
            <form id="form-lora" action="ControladorMedicamento" method="POST">
                <h2 class="form-title2">Editar Medicamento</h2>
                <div class="contenedor-inputs">
                    <input type="text" id="inputs2" class="form-input" name="txtid1m" value="${datos.getId_m()}">
                    <input type="text" id="inputs2" class="form-input" name="txtnom1m" value="${datos.getNom_m()}">
                    <input type="text" id="inputs2" class="form-input" name="txtvia1" value="${datos.getV_admin()}">
                    <input type="hidden" name="id" value="${datos.getId_m()}">
                    <input type="submit" class="btn-submit2" name="accion2" value="Actualizar" >
                </div>
            </form>
            <br>
            <div class="espacio">
