    ...
    <center>
        <div>
            ...
            <form action="ControladorFamiliar" method="POST">
                ...
                <input class="Boton"type="submit" name="accion3" value="Mis familiares">
        ...
        <div>   
            <table border="3">
                ...
                <tbody>
                    <c:forEach var="datos6" items="${datos6}"> 	
                        <tr>    
                            <td style="text-align: center;">${datos6.getId_usu()}</td>   
                            <td style="text-align: center;">${datos6.getId_pac()}</td>  
                            <td style="text-align: center;">${datos6.getParentesco()}</td>  
                            <td style="text-align: center;">
                                <form action="ControladorFamiliar" method="POST">
                                    <input type="hidden" name="idfa" value="${datos6.getId_usu()}">
