...
<html>
    ...
    <body>
        ...
        <div id="page">
                                ...
                                <div class="display-tc">
                                    <div class="row">
                                        <div class="col-md-8 animate-box">
                                            <h1 style="padding-top: 200px"><strong>Agregar familar</strong></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <form id="form-lora" action="ControladorFamiliar" method="POST">
                <h2 class="form-title2"><span>Añadir familiar</span></h2>
                <div class="contenedor-inputs">
                    <input type="text" id="inputs2" class="form-input" placeholder="Identificación" required name="txtiduf">
                    <input type="text" id="inputs2" class="form-input" placeholder="Identificación del paciente" required name="txtidpf">
                    <select name="txtparentesco" id="inputs2" class="form-input" required>
                        ...
                        <option value="5">Tio/Tia</option>
                        <option value="6">Sobrino/Sobrina</option>
                        <option value="7">Primo/Prima</option>
                        <option value="8">Amigo/Amiga</option>
                    </select>
                    <input type="submit" class="btn-submit2" name="accion3" value="Agregar">
                </div>
            </form>
            <br>
            <div class="espacio">
