...
<html>
    ...
    <center>
        <div>
            <h1 class="no-margin"><strong>Familiares Registrados</strong></h1>
            <form action="ControladorFamiliar" method="POST">
                <input type="search" id="miBusqueda" name="q">
                <a href="" onClick= return><input type="button" value="Buscar"></a><br><br>
                <input class="Boton"type="submit" name="accion3" value="Listar">
                <input class="Boton" type="submit" name="accion3" value="Nuevo">
            </form>
        </div>
        <br>
        <div>   
            <table border="3">
                ...
                <tbody>
                    <c:forEach var="datos3" items="${datos3}"> 	
                        <tr>    
                            <td style="text-align: center;">${datos3.getId_usu()}</td>   
                            <td style="text-align: center;">${datos3.getId_pac()}</td>  
                            <td style="text-align: center;">${datos3.getParentesco()}</td>  
                            <td style="text-align: center;">
                                <form action="ControladorFamiliar" method="POST">
                                    <input type="hidden" name="idfa" value="${datos3.getId_usu()}">
                                    <input class="Boton" type="submit" name="accion3" value="Editar">
                                    <input class="Boton2" type="submit" name="accion3" value="Eliminar">
                                </form>
                            </td>
                        </tr>
                    </c:forEach>  
